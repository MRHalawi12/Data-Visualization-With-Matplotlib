print(">>>> MINI PROJECT LATIHAN MATPLOTLIB 2<<<<<")
...
plt.tight_layout()
plt.show()
#CASE 3: KUANTITAS PENJUALAN BRAND TOP 5SELAMA DESEMBER 2019
print('BAR CHART')
import matplotlib.pyplot as plt
plt.clf()
...
print(">>>>Korelasi quantity vs GMV<<<<")
import matplotlib.pyplot as plt
#agregat per product
...
plt.show()
print(">>>>>Case 6b: Korelasi median harga vs quantity<<<")
import matplotlib.pyplot as plt
plt.clf()
#agregat per product
data_per_product_top5brand_dec = dataset_top5brand_dec.groupby('product_id').agg({'quantity': 'sum', 'gmv':'sum', 'item_price':'median'}).reset_index()
